...
2017/04/18: NOTE: two people have reported that while this 6 year old example works using AppEngine (specifially in dev mode), that they had problems running under Tomcat. We should probbly consider this example to be deprecated or "past it's sell by date."
